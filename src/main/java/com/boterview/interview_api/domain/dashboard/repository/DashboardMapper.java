...
public interface DashboardMapper {
        ...
        List<DashboardSettingResponseDto.PreQuestionDto> findPreQuestionsBySettingId(
        ...
        List<DashboardInterviewDetailResponseDto.QuestionDto> findInterviewQuestionsByInterviewId(
        ...
        List<DashboardInterviewDetailResponseDto.ScoreDto> findInterviewScoresByInterviewId(
                        @Param("interviewId") String interviewId);
        ...
        List<DashboardMaterialResponseDto.MaterialDto> findMaterialsByInterviewId(
                        @Param("interviewId") String interviewId);
